...
class Slipfire_Widget_Tabber extends WP_Widget {
	...
	function Slipfire_Widget_Tabber() {
		...
		parent::__construct( 'slipfire-tabber', __('WPZOOM: Tabs', 'wpzoom'), $widget_ops, $control_ops );
	}
...
if ( ! function_exists( 'yamidoo_scripts' ) ) {

	function yamidoo_scripts() {

		$protocol = is_ssl() ? 'https' : 'http';

		// Load our main stylesheet.
		wp_enqueue_style( 'yamidoo-style', get_stylesheet_uri() );
		...
		wp_enqueue_script( 'slider', get_template_directory_uri() . '/js/slider.js', array( 'jquery' ), WPZOOM::$themeVersion, true );


		/* Google Fonts */
		wp_enqueue_style( 'google-fonts', "$protocol://fonts.googleapis.com/css?family=Prata|Droid+Serif:400,700,400italic,700italic" );

	}

}

add_action( 'wp_enqueue_scripts', 'yamidoo_scripts' );
?>