			...
			<div id="header">
 				...
 				<div id="topmenu">
					...
					if ( option::get('head_facebook_show') == 'on' && strlen(option::get('head_facebook_url')) > 1 ) { ?> <a href="<?php echo option::get('head_facebook_url'); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/icons/facebook.png" alt="Facebook" /></a><?php }
 					...
 					?>
 					<a href="https://www.instagram.com/owcatalyst/"><img src="http://www.oldwestburycatalyst.org/wp-content/themes/the-catalyst/instagram.png" width="19" /></a>
				...
				<div id="logo">
					...
					<?php if (option::get('logo_desc') == 'on') {  ?><div id="headerBar"><span><?php bloginfo('description'); ?></span></div><?php } ?>
				</div><!-- / #logo -->
